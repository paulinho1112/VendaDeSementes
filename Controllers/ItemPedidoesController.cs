...
namespace VendaDeSementes.Controllers
{
    public class ItemPedidoesController : Controller
    {
        ...
        public ItemPedidoesController(Contexto context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.ItemPedidos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,PedidoID,ProdutoID,Quantidade,Preco")] ItemPedido itemPedido)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ID,PedidoID,ProdutoID,Quantidade,Preco")] ItemPedido itemPedido)
        {
            if (id != itemPedido.ID)
            {
                return NotFound();
